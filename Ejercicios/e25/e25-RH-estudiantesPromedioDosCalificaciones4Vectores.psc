// algoritmo que lea en un vector el nombre de un grupo de estudiantes y que también lea en dos vectores sus calificaciones y que imprima el nombre del estudiante y su promedio, los promedios estarán guardados en otro vector.
